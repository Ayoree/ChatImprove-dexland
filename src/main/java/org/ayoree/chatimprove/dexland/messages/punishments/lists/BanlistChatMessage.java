...
public class BanlistChatMessage extends PunishlistChatMessage {
    public BanlistChatMessage(Text message) {
        super(message);
    }
        ...
        public Predicate<Text> validator() {
            return message -> {
                ...
                return (
                    ...
                    siblings.get(2).getString().startsWith("забанен ") &&
    ...
    public ChatMessage generateChangedMsg() {
        ...
        String unbanStr = "/unban " + getReceiverNick();
        ...
        if (Config.getInst().isAutoServerSuffix) {
            ...
            unbanStr = unbanStr.concat(" server:" + m_server);
        }
        ...
        final Style receiverStyle = siblings.get(s_receiverIndex).getStyle()
            .withClickEvent(new ClickEvent.SuggestCommand(unbanStr))

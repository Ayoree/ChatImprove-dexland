...
public class UnwarnlistChatMessage extends UnPunishlistChatMessage {
    public UnwarnlistChatMessage(Text message) {
        super(message);
    }
        ...
        public Predicate<Text> validator() {
            return message -> {
                ...
                return (
                    ...
                    siblings.get(2).getString().equals("отменено предупреждение ")
                );
            };
        }
        @Override
        public Function<Text, ChatMessage> creator() {
            return UnwarnlistChatMessage::new;
        }
    }

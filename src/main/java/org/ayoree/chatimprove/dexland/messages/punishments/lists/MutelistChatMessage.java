...
public class MutelistChatMessage extends PunishlistChatMessage {
    public MutelistChatMessage(Text message) {
        super(message);
    }
    ...
    public static class ProviderImpl extends AddonInformerImpl implements Provider {
        ...
        public Predicate<Text> validator() {
            return message -> {
                ...
                return (
                    ...
                    siblings.get(2).getString().startsWith("замучен ") &&
        ...
        public Function<Text, ChatMessage> creator() {
            return MutelistChatMessage::new;
        }
    }

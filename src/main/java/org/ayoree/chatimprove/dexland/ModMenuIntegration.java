            ...
            .category(ConfigCategory.createBuilder()
                ...
                .group(OptionGroup.createBuilder()
                    ...
                    .option(Option.<String>createBuilder()
                        ...
                        .build())
                    .option(Option.<String>createBuilder()
                        .name(Text.literal("Некорректный jail"))
                        .description(OptionDescription.of(Text.literal("Команда, которая предлагается, если нажать на ник того, кто посадил игрока")))
                        .binding("/ban {NICKNAME} 1h 4.21 [Некорректный jail игрока `{RECEIVER}`]", () -> Config.getInst().incorrectJailMsg, newVal -> Config.getInst().incorrectJailMsg = newVal)
                        .controller(StringControllerBuilder::create)
                        .build())
                    .option(Option.<String>createBuilder()
                    ...
                    .option(Option.<String>createBuilder()
                        ...
                        .build())
                    .option(Option.<String>createBuilder()
                        .name(Text.literal("Некорректный jail free"))
                        .description(OptionDescription.of(Text.literal("Команда, которая предлагается, если нажать на ник того, кто освободил игрока из тюрьмы")))
                        .binding("/ban {NICKNAME} 1h 4.20 [Некорректное освобождение игрока `{RECEIVER}`]", () -> Config.getInst().incorrectUnjailMsg, newVal -> Config.getInst().incorrectUnjailMsg = newVal)
                        .controller(StringControllerBuilder::create)
                        .build())
                    .build())
                .group(OptionGroup.createBuilder()
